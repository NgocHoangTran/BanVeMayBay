...
{
    public class BookTicket01Controller : Controller
    {
        // GET: BookTicket01
        // GET: BookTicket
        ...
        {
            NguoiDung u = Session["nguoiDung"] as NguoiDung;
            if(u == null)
            {
                ViewBag.mess = "Ban phai dang nhap de dat ve";
            ...
            return RedirectToAction("Form", "BookTicket01");
        }
